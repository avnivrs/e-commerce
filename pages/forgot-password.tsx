...
const ForgotPassword = () => {
  ...
  return (
    <MainLayout>
      ...
      {emailSent ? (
        <aside className='auth-scroll relative font-medium text-[14px] leading-[17px] overflow-y-auto w-[690px] max-h-[690px] text-black bg-white border border-[rgba(102,102,102,0.5)] rounded-3xl pt-[60px] pb-[30px] px-[92px] laptops:px-[210px] laptops:w-full laptops:max-w-[90vw] phones:max-w-[100vw] phones:rounded-none phones:h-screen phones:px-5 phones:pt-[100px]'>
        ...
        <aside className='relative overflow-y-auto w-[690px] max-h-[690px] text-black bg-white border border-[rgba(102,102,102,0.5)] rounded-3xl pt-[79px] pb-[30px] px-[70px] laptops:px-[187px] laptops:w-full laptops:max-w-[90vw] phones:max-w-[100vw] phones:rounded-none phones:h-screen phones:px-5 phones:pt-[100px]'>
